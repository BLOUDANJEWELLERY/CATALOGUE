        ...
        {success ? (
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              onClick={handleReset}
              disabled={loading}
              className="w-full px-4 py-2 bg-[#0b1a3d] text-[#c7a332] font-semibold rounded-lg hover:bg-[#1a2b4c] hover:text-[#ffd700] transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
